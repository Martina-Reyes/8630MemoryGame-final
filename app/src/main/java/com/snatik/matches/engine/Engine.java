    ...
    public void onEvent(ResetBackgroundEvent event) {
        ...
        if (drawable != null) {
            ...
            executor.execute(() -> {
                ...
                Bitmap b = Utils.scaleDown(R.drawable.emoji_bg, Utils.screenWidth(), Utils.screenHeight());
...
//                    Bitmap bitmap = Utils.scaleDown(R.drawable.emoji_bg, Utils.screenWidth(), Utils.screenHeight());
//                    return bitmap;
//                }
//
        ...
        if (mFlippedId == -1) {
            ...
            if (mPlayingGame.boardArrangment.isPair(mFlippedId, id)) {
                ...
                if (mToFlip == 0) {
                    ...
                    Memory.saveTime(mPlayingGame.theme.getId(), mPlayingGame.boardConfiguration.difficulty, gameState.passedSeconds);
